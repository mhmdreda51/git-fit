      ...
      body: Column(
          children: [
            ...
            Container(
              ...
              child: Container(alignment: Alignment.centerLeft,child: Text('Abs',style: widgetTitle,)),
            ),
            Expanded(
              child: ListView.builder(
                  itemCount: 10,
                  itemBuilder: (context , index){
                    return ExcricesCard(name: 'Incline Bench Sit-Ups',ex: 'Abs',img: 'assets/images/abs1.png', colorDivider: const Color(0xFF8BAAD4),);
                  }),
            )
          ]),
    );
